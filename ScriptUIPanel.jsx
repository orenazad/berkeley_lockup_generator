...
function createDialog() {
    ...
    // CSVRANGEPANEL
    // =============
    var csvRangePanel = CSVPanel.add("panel", undefined, undefined, {name: "csvRangePanel"}); 
        csvRangePanel.text = "Custom Range"; 
        csvRangePanel.orientation = "row"; 
        csvRangePanel.alignChildren = ["left","center"]; 
        csvRangePanel.spacing = 10; 
        csvRangePanel.margins = 10; 
        csvRangePanel.alignment = ["center","top"]; 

    // RANGEPANELRADIOGROUP
    // ====================
    var rangePanelRadioGroup = csvRangePanel.add("group", undefined, {name: "rangePanelRadioGroup"}); 
        rangePanelRadioGroup.orientation = "column"; 
        rangePanelRadioGroup.alignChildren = ["left","center"]; 
        rangePanelRadioGroup.spacing = 20; 
        rangePanelRadioGroup.margins = 0; 
        rangePanelRadioGroup.alignment = ["left","fill"]; 

    var singleLineRadioButton = rangePanelRadioGroup.add("radiobutton", undefined, undefined, {name: "singleLineRadioButton"}); 
    ...
    var customRangeRadioButton = rangePanelRadioGroup.add("radiobutton", undefined, undefined, {name: "customRangeRadioButton"}); 
        customRangeRadioButton.helpTip = "Export a range of lines from the CSV file. Disables any other forms of  export."; 
        customRangeRadioButton.text = "Range"; 

    // CSVRANGEGROUP
    // =============
    var csvRangeGroup = csvRangePanel.add("group", undefined, {name: "csvRangeGroup"}); 
        csvRangeGroup.orientation = "column"; 
        csvRangeGroup.alignChildren = ["left","center"]; 
        csvRangeGroup.spacing = 10; 
        csvRangeGroup.margins = 0; 

    var singleLineText = csvRangeGroup.add('edittext {justify: "center", properties: {name: "singleLineText"}}'); 
        singleLineText.helpTip = "CSV line to export."; 
        singleLineText.text = "Line Number"; 
        singleLineText.preferredSize.width = 92; 
        singleLineText.alignment = ["fill","center"]; 

    // RANGEGROUPRANGETEXT
    // ===================
    var RangeGroupRangeText = csvRangeGroup.add("group", undefined, {name: "RangeGroupRangeText"}); 
        RangeGroupRangeText.orientation = "row"; 
        RangeGroupRangeText.alignChildren = ["left","center"]; 
        RangeGroupRangeText.spacing = 10; 
        RangeGroupRangeText.margins = 0; 

    var startRangeText = RangeGroupRangeText.add('edittext {justify: "center", properties: {name: "startRangeText"}}'); 
    ...
    var statictext1 = RangeGroupRangeText.add("statictext", undefined, undefined, {name: "statictext1"}); 
        statictext1.text = "-"; 
        statictext1.alignment = ["left","center"]; 

    var endRangeText = RangeGroupRangeText.add('edittext {justify: "center", properties: {name: "endRangeText"}}'); 
    ...
    var outputPathText = outputGroup.add("statictext", undefined, undefined, {name: "outputPathText"}); 
    ...
    var selectOututPathIconButton = outputGroup.add("iconbutton", undefined, File.decode(selectCSVInputIconButton_imgString), {name: "selectOututPathIconButton", style: "toolbutton"}); 
        ...
        selectOututPathIconButton.preferredSize.width = 10; 
        selectOututPathIconButton.alignment = ["left","top"]; 

    // DIALOG
    // ======
    var exportButton = dialog.add("button", undefined, undefined, {name: "exportButton"}); 
        exportButton.text = "Export"; 
        exportButton.alignment = ["fill","top"]; 
    ...
    RangeGroupRangeText.enabled = customRangeRadioButton.value;
    ...
    singleLineRadioButton.onClick = function() {
        if (singleLineRadioButton.value) {
            ...
            singleLineRadioButton.value = true;
        }
        singleLineText.enabled = singleLineRadioButton.value;
        RangeGroupRangeText.enabled = customRangeRadioButton.value;
    }
