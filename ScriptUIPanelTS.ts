...
function createDialog() {
    ...
    exportButton.onClick = function() {
        ...
        // Honestly maybe just make these radio buttons for simplicity. TODO:
        // TODO: We also need to change the colorSpace settings for illustrator for this.
        options['CMYK'] = cmykCheckbox.value;
        options['RGB'] = rgbCheckbox.value;
