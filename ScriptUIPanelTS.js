...
function createDialog() {
    ...
    selectCSVInputIconButton.onClick = function () {
        var csvFile = File.openDialog('Open CSV File', 'CSV:*.csv');
        var csvFileSuccess = csvFile.open('r');
        if (!csvFileSuccess) {
    ...
    exportButton.onClick = function () {
        ...
        var doc = openMasterDocument(true);
        if (!doc) {
            return;
        }
        ...
        var BerkeleyBlue = generateColors('CMYK', 'blue');
        var CaliforniaGold = generateColors('CMYK', 'gold');
        var White = generateColors('CMYK', 'white');
        var colorSchemes = [
